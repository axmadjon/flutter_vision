...
class FaceDetectorPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (Face face in faces) {
      ...
      var leftEye = face.leftEyeOpenProbability.toStringAsFixed(3).toString();
      var rightEye = face.rightEyeOpenProbability.toStringAsFixed(3).toString();
      var smilling = face.smilingProbability.toStringAsFixed(3).toString();

      var name = "LeftEye: "+leftEye+", RightEye: "+rightEye;
      name += ", smile: " +smilling;
